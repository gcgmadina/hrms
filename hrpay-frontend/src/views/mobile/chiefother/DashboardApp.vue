<template>
  ...
  <footer class="bottom-tabs">
    <router-link to="/mobile/chief-other/dashboard" class="tab-item" :class="{ active: isActive('/mobile/chief-other/dashboard') }">
      <div class="icon">🏠</div>
      <span>Home</span>
    </router-link>
    <router-link to="/mobile/chief-other/leave-request" class="tab-item" :class="{ active: isActive('/mobile/chief-other/leave-request') }">
      <div class="icon">📚</div>
